const timeout = process.env.DEBUG ? 99999999 : 200000
...
exports.config = {
    ...
    cucumberOpts: {
        ...
        tags: ['~@manual', '~@wip'], // <string[]> (expression) only execute the features or scenarios with tags matching the expression
